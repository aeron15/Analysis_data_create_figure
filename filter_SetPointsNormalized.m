...
BC187_sorted=sort(BC187_vals_vector);

BC187sorted_mean=nanmean(BC187_sorted(11:end-10));
BC187sorted_std=nanstd(BC187_sorted(11:end-10));
BC187sorted_median=median(BC187_sorted(11:end-10));

BC187_vals_smaller_idx=BC187_vals_vector<=(BC187sorted_median-BC187sorted_std);
sum(BC187_vals_smaller_idx)
higher_bound=BC187sorted_median-BC187sorted_std;
lower_bound=BC187sorted_median-BC187sorted_std;

%BC187_vals_smaller_idx
%%
